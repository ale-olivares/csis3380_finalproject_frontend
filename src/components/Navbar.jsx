    ...
    <>
      <div className="fixed-top w-full z-10">
        <section className="relative mx-auto">
          {/* <!-- navbar --> */}
          <nav className="flex justify-between  bg-gradient-to-r from-backgroundColor to-brightColor shadow-[0_3px_10px_rgb(0,0,0,0.2)] text-white">
            <div className="px-5 xl:px-12 py-6 flex w-full items-center">
              ...
              <h1 className="pl-2 text-xl text-white font-semibold">
                CoffeeBeans.
              </h1>
                ...
                {user ? (
                  <>
                    ...
                    <NavLink to="/">
                      <button
                        onClick={() => logout()}
                        className="mr-10 flex flex-col items-center"
                      >
                        <svg
            ...
            {user && !isAdmin && (
              ...
              >
                <FaCartShopping size={25} style={{ color: "white" }} />
                {totalItemsCart >= 0 && (
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-red-500 p-1 text-xs text-white absolute  -right-2 transform translate-x-1/2 -translate-y-1/2">
                    {totalItemsCart}
                  </span>
                )}
              </NavLink>
            ...
            <button
              ...
              className="navbar-burger mr-12 xl:hidden"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 hover:text-gray-200"
