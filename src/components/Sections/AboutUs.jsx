...
const AboutUs = () => {
    return (
        <div className=" min-h-screen flex flex-col items-center justify-center lg:px-32 px-5 bg-[#FFFF] text-black">
            <h1 className=" font-semibold text-center text-3xl lg:mt-14 mt-24 mb-8"> Our mission:
                <br />
                We want to provide our community with
            ...
            <div className=" flex flex-col lg:flex-row items-center gap-5">
                ...
                <div className=" w-full lg:w-2/4 p-4 space-y-3">
                    ...
                    <p>
                        ...
                        rest with our unwavering dedication to providing our community with an excellent

                        product and love for specialty coffee.
                    </p>
                    <p>
